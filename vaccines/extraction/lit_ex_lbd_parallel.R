...
# Run:    "qsub -l m_mem_free=4G -P proj_geo_nodes -q geospatial.q -l fthread=10 -l archive=TRUE -N PARENT_lit_resampling 
#          FILEPATH -e s FILEPATH 
#          --action parent --project proj_geo_nodes --nid all --antigen hepb"
#***********************************************************************************************************************
...
if(action == "parent") {
  ...
  outdir_vaccine <- paste0(outdir, "/resampled_lit_extractions_nid/", vaccine_to_run, "/")
